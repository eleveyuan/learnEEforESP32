...
| 数字信号处理 | 《离散时间信号处理》奥本海默（第三版） |⭐⭐⭐⭐⭐| <li> **2025.03.06** 开始学习 <li> **2025.03.15** 完成离散时间信号与系统（第2章）<li> **2025.04.25** 完成采样（第4章） <li> **2025.05.13** 完成z变换（第3章）  <li> **2025.05.20** 完成DFT（第8章）  <li> **2025.06.01** 完成FFT（第9章）**2025.06.07** 完成滤波器设计workflow（第7章） | |
